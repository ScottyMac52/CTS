local diff = {
	...
	["keyDiffs"] = {
		...
		["d3008pnilu3008cd5vd1vpnilvu0"] = {
			...
			["name"] = "EMERG HYD Pushbutton - ON/OFF",
		},
		...
		["d3023pnilunilcd80vd1vpnilvunil"] = {
			["added"] = {
				[1] = {
					["key"] = "JOY_BTN11",
					["reformers"] = {
			...
			["name"] = "CMWS Flare Jettison Switch Cover - OPEN/CLOSE",
		},
